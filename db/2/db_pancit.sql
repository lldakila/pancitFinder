...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2018 at 02:26 AM
...
--
ALTER TABLE `tbl_pcomment`
  MODIFY `pc_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `tbl_userprofile`
  MODIFY `up_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
